 ...
 *      Philippe 2018-2026, philippe_44@outlook.com
 *
...
struct codec *register_opus(void) {
	...
	LOG_SQ_INFO("using opus to decode ops");
	return &ret;
}
#endif /* OPUS */
